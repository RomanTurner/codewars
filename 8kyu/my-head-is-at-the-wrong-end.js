...
Something has gone terribly wrong - someone has gone and switched their 
...
It is your job to re-arrange the array so that the animal is the right way round 
(head, body, tail).
...
function fixTheMeerkat(array) {
  //pop the last item off into a variable
    // shift first item off into a variable
    //push-unshift items onto the array. 
    let tail = array.shift();
    let head = array.pop();
     array.unshift(head);
    array.push(tail);
    return array; 
